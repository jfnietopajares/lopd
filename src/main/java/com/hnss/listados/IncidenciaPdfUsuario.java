...
public class IncidenciaPdfUsuario {
	private static final Logger logger = LogManager.getLogger(IncidenciaPdfUsuario.class);
	...
	public IncidenciaPdfUsuario(LopdIncidencia inciParamIncidencia) {
